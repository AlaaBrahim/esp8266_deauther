...
public:
    ...
    void start();
    void start(bool beacon, bool deauth, bool deauthAll, bool probe, bool evil, bool output, uint32_t timeout);
    void stop();
    void update();
